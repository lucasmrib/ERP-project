...
<body class="h-full">
    <main class="grid min-h-full place-items-center bg-zinc-600 px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
            <p class="text-base font-semibold text-indigo-500">404</p>
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6">
              <a href="#" class="bg-indigo-500 hover:bg-indigo-400 hover:shadow-lg hover:shadow-black duration-200 font-semibold rounded-lg px-3.5 py-2.5">Go back home</a>
